...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Overlay
    ...
    className={cn('fixed inset-0 bg-secondary/80 backdrop-blur-sm', className)}
    {...props}
  />
));
...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        'fixed grid w-full max-w-xs gap-4 border border-gray-200 bg-secondary p-6 shadow-lg rounded-sm',
        className
      )}
      {...props}
    >
